...
# NDRE must use B8A (20 m), never B08 (10 m).
replace_once(
    "indices.py",
    '"NDRE":  ("B08", "B05"),',
    '"NDRE":  ("B8A", "B05"),',
...
# Read B8A on the native 20 m grid and align it to the 10 m reference grid.
replace_once(
    "processor.py",
